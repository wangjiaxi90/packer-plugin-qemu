...
type FlatConfig struct {
	...
	QemuImageSize       *int32            `mapstructure:"qemu_image_size" required:"false" cty:"qemu_image_size" hcl:"qemu_image_size"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"qemu_image_size":            &hcldec.AttrSpec{Name: "qemu_image_size", Type: cty.Number, Required: false},
	}
	return s
}
